...
public:
	...
	/**
	 * retrieve the next chunk that is not set in playing order : it should also not be present in sendframes and notInNeighbours
	 *
	...
	/**
	 * calculate the size of BufferMap object for setting in packets
	 *
